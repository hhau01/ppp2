// ch04 ex14 pg. 130
// MODIFIED VERSION OF EX.13: find all primes between 1 and given 100 using "Sieve of Eratosthenes" method given user input MAX
// 
...
int main() {
    ...
    int N = 100;
    cout << "Sieve of Eratosthenes - Find all primes (pick a number): ";
    while (cin >> N) {
